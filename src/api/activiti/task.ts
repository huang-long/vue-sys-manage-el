...
export function queryViewerData(params: { procDefId: string; instanceId: string }) {
  // TODO
  console.log(params);
  return new Promise<{ code: number; msg: string; data: { actList: TaskHistoryObj[]; bpmnXml: string } | undefined }>((resolve) => {
    resolve({
      msg: "操作成功",
      code: 200,
      data: {
        actList: [
          {
            actId: "5253cf07-e507-11ee-a8ff-aed1b8855c31",
            actName: "开始",
            actType: "startEvent",
            actKey: "Event_0t0bht1",
            instanceId: "52510fe1-e507-11ee-a8ff-aed1b8855c31",
            status: "1",
            assignee: "admin",
            assigneeName: "若依",
            startTime: "2024-03-18 17:10:10",
            endTime: "2024-03-18 17:10:10",
          },
          {
            actId: "52541d28-e507-11ee-a8ff-aed1b8855c31",
            actName: "A级审批",
            actType: "userTask",
            actKey: "Activity_1tdjm96",
            instanceId: "52510fe1-e507-11ee-a8ff-aed1b8855c31",
            status: "1",
            assignee: "zhangsan",
            assigneeName: "张三",
            ...
            reason: "大声道",
            startTime: "2024-03-18 17:10:10",
            endTime: "2024-03-18 17:11:58",
          },
          {
            actId: "92e6e04e-e507-11ee-a8ff-aed1b8855c31",
            actName: "B级审批",
            actType: "userTask",
            actKey: "Activity_1tc3fcv",
            instanceId: "52510fe1-e507-11ee-a8ff-aed1b8855c31",
            status: "0",
            startTime: "2024-03-18 17:11:58",
          },
        ],
        bpmnXml:
